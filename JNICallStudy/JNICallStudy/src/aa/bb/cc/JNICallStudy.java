 ...
 * 'libJNICallStudy.so' and provides an access to exported C functions.
 * The library is packaged into and installed with the application's APK.
 * The native method is implemented in the C file /jni/JNICallStudy.c file
 * 
 * For more information on JNI, see: http://java.sun.com/docs/books/jni/
 */

public class JNICallStudy extends Activity
{
    private TextView tv;
     ...
     * <code>Java_aa_bb_cc_JNICallStudy_stringFromJNI</code>
     * for the implementation details.
     */
    public native String stringFromJNI();

    /* This is another native method declaration that is *not*
     * implemented by 'JNICallStudy'. It demonstrates that
     ...
     * 'JNICallStudy' library when the class is
     * loaded.
     */
    static { System.loadLibrary("JNICallStudy"); }
}
