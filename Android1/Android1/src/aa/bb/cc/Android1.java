 ...
 * 'libAndroid1.so' and provides an access to exported C functions.
 * The library is packaged into and installed with the application's APK.
 * The native method is implemented in the C file /jni/Android1.c file
 * 
...
public class Android1 extends Activity
{
     ...
     * <code>Java_aa_bb_cc_Android1_stringFromJNI</code>
     * for the implementation details.
     */
    public native String stringFromJNI();

    /* This is another native method declaration that is *not*
     * implemented by 'Android1'. It demonstrates that
     ...
     * loaded.
     */
    static { System.loadLibrary("Android1"); }
}
