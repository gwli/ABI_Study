 ...
 * 'libJNI_call_study.so' and provides an access to exported C functions.
 * The library is packaged into and installed with the application's APK.
 * The native method is implemented in the C file /jni/JNI_call_study.c file
 * 
 * For more information on JNI, see: http://java.sun.com/docs/books/jni/
 */

public class JNI_call_study extends Activity
{
    private TextView tv;
     ...
     * <code>Java_aa_bb_cc_JNI_call_study_stringFromJNI</code>
     * for the implementation details.
     */
    public native String stringFromJNI();

    /* This is another native method declaration that is *not*
     * implemented by 'JNI_call_study'. It demonstrates that
     ...
     * 'JNI_call_study' library when the class is
     * loaded.
     */
    static { System.loadLibrary("JNI_call_study"); }
}
